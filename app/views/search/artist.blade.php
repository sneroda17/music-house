...
@section('meta-content')
	...
	<meta property="og:title" content="{{ $settings->website_name }} - {{ $searchKey }} Artists"/>
	<meta property="og:image" content="{{ URL::asset('assets/images/logo.png') }}"/>
	<meta property="og:description" content="{{ $settings->website_name }} - {{ $searchKey }} Artists"/>
	<title>{{ $settings->website_name }} - {{ $searchKey }} Artists</title>
@stop
