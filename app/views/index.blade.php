...
<head>
	...
	<!--script-attachment-index start-->
	<link rel="stylesheet" href="{{ URL::asset('assets/css/style2.css?v=2') }}" />
	...
	<script type="text/javascript" src="{{ URL::asset('assets/js/dropdown.js?v=2') }}"></script>
		...
		<div class="sm2-bar-ui full-width pull-left">
	        <div class="bd sm2-main-controls">
	        	<div class="sm2-inline-element hidden">
	                {{--<a class="navbar-brand logo hidden-xs pjax" title="{{ $settings->website_name }}" >
                                ...
                                <div class="sm2-progress-bd">
                                   ...
                                   <div class="sm2-progress-track">
                                    ...
                                    <div class="sm2-progress-bar"></div>
                                        ...
                                        {{--<img class="track-img" src="{{ URL::to('assets/img/bootstrap-colorpicker/line.png') }}">--}}
...
<div class="col-md-3 col-sm-3 col-xs-6">
  		<div class="category">
				<div class="dropdown">
	<button onclick="myFunction()" class="dropbtn">Genres <span><img src="{{ URL::asset('assets/images/menu.png') }}"/></span></button>
  	<div id="myDropdown" class="dropdown-content">
  	@foreach($genres as $i => $genre)
      <a href="{{ URL::to('category/'.$genre->slug) }}" class="pjax @if(Request::is($genre->name)) active @endif">{{ $genre->name }}</a>
      @endforeach
...
<div class="col-md-6 col-sm-6 col-xs-6">
  		<div class="search-box-filter">
				<div class="sr-f-d">
						<div class="search">
						<form  role="search" method="get" action="{{ URL::to('/') }}">
				<input type="text" name="q" placeholder="Search.." id="myInput" onkeyup="filterFunction()">
				<a href="javascript:void(0);" onclick="document.querySelector('form').submit()" id="searc-btn"><img src="{{ URL::asset('assets/images/search.png') }}"/></a>
				</form>
</div>
</div>
</div>
